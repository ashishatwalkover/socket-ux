...
export function JavaScriptPanel({ item, onClose }: PanelProps) {
        ...
        <div className="border border-gray-200 rounded-md overflow-hidden">
          <div className="flex items-center justify-between bg-gray-50">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 text-blue-600 hover:bg-gray-100 transition-colors flex-1 text-left"
            >
              <svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`text-gray-500 transition-transform ${codeOpen ? "rotate-90" : ""}`}>
          ...
          {codeOpen && (
            <div className="border-t border-gray-200 bg-white font-mono text-xs">
              {[
