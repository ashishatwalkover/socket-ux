...
/**
 * V6 is a light-only surface. The app shell can render under the system `.dark`
 * color scheme, which flips MUI's palette (Chip, Button, TextField…) to dark
 * text while V6's hand-written Tailwind grays stay light — MUI labels then
 ...
 */
export default function Ai6Layout({ children }: { children: ReactNode }) {
