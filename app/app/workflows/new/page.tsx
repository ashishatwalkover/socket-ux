      ...
      <header className="bg-white border-b border-slate-200 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <InputBase
            ...
            className="px-1"
            sx={{ fontSize: "15px", fontWeight: 600, color: "#0f172a" }}
          />
          <span className="text-[11px] text-slate-400">Draft</span>
        </div>
        <div className="flex items-center gap-2">
          <Button variant="text" size="small" startIcon={<Icon.save className="size-3.5" />} sx={{ color: "#334155" }}>
            Save
          </Button>
          <Button variant="text" size="small" startIcon={<Icon.play className="size-3.5" />} sx={{ color: "#334155" }}>
            Run
          </Button>
          <Button variant="text" size="small" startIcon={<Icon.pause className="size-3.5" />} sx={{ color: "#334155" }}>
            Pause
          </Button>
          <Button variant="text" size="small" color="error" startIcon={<Icon.trash className="size-3.5" />}>
            Delete
          </Button>
            ...
            <div className="text-center space-y-6 max-w-2xl">
              ...
              <div className="relative bg-white rounded-xl border-2 border-blue-400 shadow-sm">
                ...
                <InputBase
                  ...
                  className="w-full pl-10 pr-12 py-3 text-[13px]"
                />
                <IconButton size="small" className="absolute bottom-3 right-3" sx={{ color: "#94a3b8", "&:hover": { color: "#2563eb" } }}>
