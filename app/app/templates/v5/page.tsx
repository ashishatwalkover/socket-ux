...
/* Soft background palette — every card gets its own color (cycled). */
const CARD_STYLES = [
  { bg: "bg-rose-50", border: "border-rose-200", hover: "hover:border-rose-300", chip: "bg-white/70 border-rose-200" },
  { bg: "bg-amber-50", border: "border-amber-200", hover: "hover:border-amber-300", chip: "bg-white/70 border-amber-200" },
  { bg: "bg-emerald-50", border: "border-emerald-200", hover: "hover:border-emerald-300", chip: "bg-white/70 border-emerald-200" },
  { bg: "bg-sky-50", border: "border-sky-200", hover: "hover:border-sky-300", chip: "bg-white/70 border-sky-200" },
  { bg: "bg-violet-50", border: "border-violet-200", hover: "hover:border-violet-300", chip: "bg-white/70 border-violet-200" },
  { bg: "bg-orange-50", border: "border-orange-200", hover: "hover:border-orange-300", chip: "bg-white/70 border-orange-200" },
  { bg: "bg-teal-50", border: "border-teal-200", hover: "hover:border-teal-300", chip: "bg-white/70 border-teal-200" },
  { bg: "bg-fuchsia-50", border: "border-fuchsia-200", hover: "hover:border-fuchsia-300", chip: "bg-white/70 border-fuchsia-200" },
];
      ...
      {templates.map((template, index) => {
        ...
        return (
          <div
            ...
            className={cn(
              "rounded-2xl border overflow-hidden text-left transition-all hover:shadow-lg cursor-pointer",
              style.bg,
              style.border,
              style.hover
            )}
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  {template.chips.map((chip, idx) => (
                    <span
                      key={idx}
                      className={cn(
                        "inline-flex items-center px-3 py-1 rounded-full border text-xs font-medium text-gray-700",
                        style.chip
                      )}
                    >
                      {chip}
